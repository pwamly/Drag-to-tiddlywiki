...
exports.getThreadOrderInCurrentTeam = reselect_1.createSelector(exports.getThreadsInCurrentTeam, getThreads, function (threadsInTeam, threads) {
    var ids = tslib_1.__spread(threadsInTeam);
    return sortByLastReply(ids, threads);
});
exports.getUnreadThreadOrderInCurrentTeam = reselect_1.createSelector(exports.getThreadsInCurrentTeam, getThreads, function (threadsInTeam, threads) {
