...
export declare function getThreads(state: GlobalState): import("../../types/utilities").RelationOneToOne<UserThread, UserThread>;
export declare function getThread(state: GlobalState, threadId: $ID<UserThread> | undefined): UserThread | null;
export declare const getThreadOrderInCurrentTeam: (state: GlobalState) => Array<$ID<UserThread>>;
export declare const getUnreadThreadOrderInCurrentTeam: (state: GlobalState) => Array<$ID<UserThread>>;
